...
const double BROWNIAN_DIFF_SCALE   =    6e5;  
...
const double ADHESION_STRENGTH_LJ   =   0;      // [NOT USED IN THE RMM STUDY] pN*um
// ... Harmonic potential
...
const double DRUG_EFFECT_RATE       =   0.1;   // 1/h; // ONLY in use when TYPE_DRUG_SCHEDULE == "continuous"
